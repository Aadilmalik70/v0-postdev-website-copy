...
export const metadata: Metadata = buildMarketingMetadata({
  title: "Privacy Policy | SERP Strategists",
  description:
    "Learn how SERP Strategists collects, uses, stores, and protects your data across its AI SEO agent platform.",
  pathname: "/privacy",
});
        ...
        <div className="space-y-10">
          <section>
            ...
            <p className="text-neutral-600 leading-relaxed mb-3">
              When you use SERP Strategists, we collect:
            </p>
            <ul className="list-disc list-inside text-neutral-600 leading-relaxed space-y-2 ml-2">
              ...
              <li>
                <strong className="text-ink">Site data:</strong> URLs,
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-neutral-600 leading-relaxed space-y-2 ml-2">
              ...
              <li>
                <strong className="text-ink">Google Analytics</strong> —
                usage analytics
              </li>
              <li>
              ...
              <li>
                <strong className="text-ink">OpenAI / Anthropic</strong> —
