        ...
        <div className="max-w-6xl mx-auto px-6 py-5">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Button
                ...
                className="bg-[#ff3b30] hover:bg-[#ff3b30]/90 text-[#ececec] font-medium px-6 py-2 rounded-full text-sm"
              >
                Get Priority Access
              </Button>
            </div>
          ...
          {isOpen && (
            <div className="md:hidden mt-6 pb-6 flex flex-col gap-5 border-t border-[#1a1a1a] pt-6">
              ...
              <Button
                onClick={() => setIsModalOpen(true)}
                className="bg-[#ff3b30] hover:bg-[#ff3b30]/90 text-[#ececec] font-medium w-full rounded-full"
              >
                Get Priority Access
              </Button>
            </div>
